      ...
      <div class="container-fluid c-section">
        <div class="row">
          ...
          <div class="col-sm-6">
            ...
            <div class="a-section">
              <h2>Add a new Update Address</h2>
                ...
                <div class="a-spacing-medium a-spacing-top-medium">
                  ...
                  <div class="a-spacing-top-medium">
                    ...
                    <select class="a-select-option" v-model="country">
                      <option v-for="country in countries" :key="country.ccn3" :value="country.name.common">{{ country.name.common }}</option>
                      <option></option>
                    </select>
                  </div>
                  <!-- Full name -->
                  ...
                  <div class="a-spacing-top-medium">
                    ...
                    <textarea
                      ...
                      style="height:6em; width: 100%;" v-model="deliveryInstruction"
                    ></textarea>
                  </div>
                  <!-- Security code -->
                  <div class="a-spacing-top-medium">
...
export default {
    ...
    async asyncData({ $axios , params}){
        try{
            ...
            const singleAddress =await $axios.$get(`/api/address/${params.id}`)
             
            const [ responseResult , singleResult ]  = Promise.all([
              response, singleAddress
            ]) ; 

            return {
              countries: responseResult,
    ...
    methods:{
        async onUpdateAddress(){
            ...
            const response = await  this.$axios.put("/api/address" , data );
